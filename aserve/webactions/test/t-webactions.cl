;; -*- mode: common-lisp; package: net.aserve.test; coding:utf-8 -*-
;;
;; t-webactions.cl
;;
...
" data :test #'equal-nocr)
    ...
    (multiple-value-bind (data retcode)
	(x-do-http-request (format nil "~a/sitea/file5" prefix-local))
	
      (test "い{start_foo}ろ{start_foo}は{end_foo}に{end_foo}
" data :test #'equal-nocr)
      (test 200 retcode)
...
(def-clp-function tweb_foo_utf8 (req ent args body)
  (declare (ignore args))
  (html "｛ｓｔａｒｔ＿ｆｏｏ｝")
  (emit-clp-entity req ent body)
  (html "｛ｅｎｄ＿ｆｏｏ｝"))
